      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img src="./assets/images/projects/proje1.gif" alt="GIF do projeto Gerador de senhas." />
            <div class="buttons">
          ...
          <p>
          Gerador de : Crie senhas fortes e seguras para usar no seu dia dia, não se preocupe para que não haja esquecimento você pode gerar gerar um qrcode da sua senha e guardalo com você.
          </p>
        ...
        <div class="card">
          ...
          <p>
          Cartão de crédito : Design de um Cartão de crédito feito usando apenas Html e Css foi feito com intuito de treinar minhas habilidades com Css.
          </p>
          <p>
          <i class="fab fa-html5"></i> <i class="fab fa-css3"></i></p>
        </div>
